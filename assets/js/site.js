(function () {
  ...
  if (folds.length) {
    ...
    var applyFolds = function () { folds.forEach(function (fold) { if (phone.matches && fold.hasAttribute('data-phone-open')) { fold.open = true; return; } fold.open = fold.classList.contains('fold--always') ? false : !phone.matches; }); };
    applyFolds();
